<template>
  <layout class="layout-nav">
    <Menu mode="horizontal" theme="light"  @on-select="handleRoute">
      <div class="logo">IMUST ACM</div>
      <div>
        <MenuItem name="/">
          <Icon type="home"/>
          <span>主页</span>
        </MenuItem>
        <MenuItem name="/problem-list">
          <Icon type="navicon"/>
          <span>问题列表</span>
        </MenuItem>
        <MenuItem name="/contest-list">
          <Icon type="trophy"/>
          <span>比赛列表</span>
        </MenuItem>
      ...
      <div class="login">
        <Button type="ghost" shape="circle">Login</Button>
      </div>
    </Menu>
  </layout>
</template>
